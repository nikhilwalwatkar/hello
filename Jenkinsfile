pipeline {
    ...
    stages {
        ...
        stage('Authenticate with ECR') {
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: '405255119935',passwordVariable: 'AKIAV4WYWMQ7RGOBL3UP', usernameVariable: 'IRSyqGS+mZHAGNnLKfkZLICSiTsjc0zFQn+3A+6O')]) {
